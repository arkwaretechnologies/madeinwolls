...
const faqs = [
  {
    ...
    answer:
      "Made in Wolls Cleaning Services is a premium, police-checked and fully insured cleaning company based in Wollstonecraft, servicing the Lower North Shore, Northern Beaches and City of Sydney. With 125+ Google reviews and a 100% satisfaction guarantee, we are trusted by families and professionals across Sydney.",
  },
  {
