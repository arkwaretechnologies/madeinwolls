...
export const metadata: Metadata = {
  ...
  description:
    "Read what our clients say about Made in Wolls. 4.8/5 from 44 Google Reviews. Trusted by Sydney families.",
};
      ...
      <section className={styles.heroSection}>
        <div className={styles.heroInner}>
          ...
          <p className={styles.heroSub}>
            With 44+ Google reviews and a 4.8/5 rating, our clients trust us to
            deliver exceptional results every time. Here&apos;s what they have to say.
          </p>
          <div className={styles.ratingBadge}>
            <span className={styles.ratingStars}>★★★★★</span>
            <span className={styles.ratingNumber}>4.8/5</span>
            <span className={styles.ratingSource}>from 44 Google Reviews</span>
          </div>
        </div>
      </section>
